...
export default function Projects() {
  const projects: Project[] = [
    {
      ...
      artSVG: (
        <svg className="w-full h-full" viewBox="0 0 400 240" fill="none">
          <rect width="400" height="240" fill="#0b0c10" />
          {/* Cyberpunk grid lines receding */}
          <path d="M 0,240 L 150,120 M 400,240 L 250,120 M 200,120 L 200,240" stroke="rgba(212, 212, 216, 0.2)" strokeWidth="1.5" />
          <line x1="0" y1="200" x2="400" y2="200" stroke="rgba(212, 212, 216, 0.15)" strokeWidth="1" />
          <line x1="0" y1="160" x2="400" y2="160" stroke="rgba(212, 212, 216, 0.08)" strokeWidth="0.8" />
          
          {/* Glowing cyberpunk towers / server nodes */}
          <rect x="80" y="80" width="30" height="120" fill="rgba(20, 20, 25, 0.85)" stroke="rgba(255, 255, 255, 0.55)" strokeWidth="1.5" />
          <rect x="290" y="60" width="40" height="140" fill="rgba(20, 20, 25, 0.85)" stroke="rgba(212, 212, 216, 0.5)" strokeWidth="1.5" />
          
          {/* Core HUD rings */}
          <circle cx="200" cy="110" r="45" stroke="rgba(255, 255, 255, 0.4)" strokeWidth="1.5" strokeDasharray="10 15" className="animate-spin" style={{ transformOrigin: '200px 110px', animationDuration: '30s' }} />
          <circle cx="200" cy="110" r="30" stroke="rgba(212, 212, 216, 0.55)" strokeWidth="2" strokeDasharray="5 5" />
          
          {/* Neon wireframes crossing */}
          <path d="M 100,210 L 160,150 L 240,150 L 300,90" stroke="#ffffff" strokeWidth="2" className="glow-magenta" />
          <path d="M 60,130 L 120,70 L 280,70" stroke="#a1a1aa" strokeWidth="1.5" className="glow-purple" />
          ...
          <path d="M 215,130 L 185,90" stroke="rgba(255, 255, 255, 0.75)" strokeWidth="2" strokeLinecap="round" />
        </svg>
      ),
    },
    {
      ...
      artSVG: (
        <svg className="w-full h-full" viewBox="0 0 400 240" fill="none">
          <rect width="400" height="240" fill="#050508" />
          {/* Deep cosmos stars */}
          <circle cx="45" cy="50" r="1" fill="#fff" opacity="0.8" />
          <circle cx="120" cy="180" r="1" fill="#fff" opacity="0.6" />
          <circle cx="340" cy="70" r="1.5" fill="#ffffff" opacity="0.7" className="animate-pulse" />
          <circle cx="280" cy="190" r="1" fill="#fff" opacity="0.5" />
          
          {/* Glowing singularity/black hole in center */}
          <circle cx="200" cy="120" r="55" fill="rgba(15, 15, 18, 0.9)" />
          <circle cx="200" cy="120" r="45" stroke="rgba(212, 212, 216, 0.5)" strokeWidth="4" />
          ...
          {/* Engine flame trail */}
          <path d="M 115,92 L 95,96 L 118,90" stroke="#e4e4e7" strokeWidth="1.5" />
    ...
    },
    {
      ...
      artSVG: (
        <svg className="w-full h-full" viewBox="0 0 400 240" fill="none">
          <rect width="400" height="240" fill="#07070a" />
          
          {/* Receding tunnel/track boundaries (extreme dynamic lines) */}
          <path d="M 0,220 L 170,120 L 230,120 L 400,220" fill="rgba(255, 255, 255, 0.03)" stroke="rgba(255, 255, 255, 0.3)" strokeWidth="1.5" />
          <path d="M 50,240 L 180,120 L 220,120 L 350,240" stroke="rgba(255, 255, 255, 0.15)" strokeWidth="1" />
          
          {/* Speedy motion vertical streaks */}
          <line x1="100" y1="0" x2="80" y2="240" stroke="rgba(255, 255, 255, 0.1)" strokeWidth="2" strokeDasharray="30 40" />
          <line x1="300" y1="0" x2="320" y2="240" stroke="rgba(212, 212, 216, 0.08)" strokeWidth="2" strokeDasharray="50 30" />
          
          {/* Laser-guided neon track fences */}
          <path d="M 0,180 L 175,122" stroke="#ffffff" strokeWidth="2" className="glow-magenta" />
          <path d="M 400,180 L 225,122" stroke="#d4d4d8" strokeWidth="2" className="glow-purple" />
          
          {/* Anti-grav racing craft zooming away */}
          <path d="M 185,160 L 200,145 L 215,160 L 200,157 Z" fill="rgba(20, 20, 24, 0.95)" stroke="#fff" strokeWidth="1.5" />
          
          {/* Giant propulsion blast circles */}
          <ellipse cx="200" cy="165" rx="18" ry="5" stroke="#ffffff" strokeWidth="1.5" opacity="0.8" className="animate-pulse" />
          <ellipse cx="200" cy="170" rx="30" ry="8" stroke="#e4e4e7" strokeWidth="1" opacity="0.5" />
          
          {/* High speed telemetry reading */}
          <text x="310" y="35" fill="#ffffff" fontFamily="monospace" fontSize="9" fontWeight="bold" className="glow-magenta">843 KM/H</text>
  ...
  return (
    <motion.section
      ...
      className="relative min-h-screen py-24 px-4 z-10 max-w-5xl mx-auto font-rajdhani"
    >
      {/* Section Header */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {projects.map((project) => (
          <TiltWrapper key={project.id} className="h-[560px]" maxTilt={8}>
            <motion.div
              variants={itemVariants}
              className="group relative rounded-2xl glass-panel border border-white/10 overflow-hidden flex flex-col justify-between hover:border-cyber-magenta/40 hover:shadow-[0_15px_45px_rgba(255,255,255,0.08)] transition-all duration-500 h-full w-full"
            >
              ...
              <div className="relative h-48 overflow-hidden border-b border-white/10">
                ...
                <div className="absolute bottom-3 left-4 font-orbitron text-[9px] uppercase tracking-[0.15em] font-medium text-cyber-neon px-2 py-0.5 bg-[rgba(15,15,20,0.85)] rounded-full border border-cyber-neon/30 backdrop-blur-sm">
                  {project.genre}
                </div>
              </div>
